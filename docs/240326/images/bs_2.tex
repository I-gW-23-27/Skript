...
\begin{document}
\begin{tikzpicture}
    \node[draw, square, fill=gray, label=below:0] (a0) {2};
    \node[draw, square, fill=gray, label=below:1, right=0cm of a0] (a1) {4};
    \node[draw, square, fill=gray, label=below:2, right=0cm of a1] (a2) {6};
