...
\begin{tikzpicture}
    ...
    \draw[doublearrow] (a21.north) .. controls +(up:0.75cm) and +(up:0.75cm) .. (c21.north);
    ...
    \draw[doublearrow] (b22.north) .. controls +(up:0.75cm) and +(up:0.75cm) .. (e22.north);
    ...
    \draw[myarrow] (c23h) edge (c23.north);
    ...
    \draw[myarrow] (d24h) edge (d24.north);
